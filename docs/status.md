...
| **I** iOS | **F6 build `fb28d99` on Brad's iPhone (no launch) and iPad**: VU1 speed-ups (VR2 stage 1), HP1, save states compiled in (off), 4× SSAA + 1024×896 + pipelined + zero-copy, his save + manual play. | Brad's play; I28 iPad layout | Brad's play |
