...
| G (GS composite) | G38 gated PASS (rule 4: Mac-B lands, Odin-B load) | clone `3a66c19` | G39: G26+G28 regression/adoption gate → G40 sub-vsync F1/F2/F3 wall | Odin slot (booked per run) |
