...
| --- | --- | --- | --- |
| **N** Android / Odin | **Brad's play build = F7** (APK `825b436d`, fork `5d5c382`, `-O3`, full-screen Vulkan present; env `ef9f94e1…` = his keys + `PS2X_MTVU=1 PS2X_VU1_BLOCKS=1` + core pins; LAG off pending Brad). **Race 0.391×** (1.49× vs F6; +LAG 0.425×). Canonical play state `~/dev/ssx3-work/odin-play/`. | Brad: LAG default; CP1 critical-path timeline; immersive mode | Brad (LAG) |
