...
- [ ] **Live panes:** g9 (geometry-alignment probe, ps2xGS, 4h) · t28 (Single Event Cross → submenu, bytesize, 4h) · i8 (audio-wall device repro, fork worktree + iPhone, 6h) · mf2 (MF app-option map + toggle prototype, 6h).
