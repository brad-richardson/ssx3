...
- [x] **N8D7M12 Part 6M5 (`b9efb6de`):** clean fork, dirty
      renderer/Granite, codegen and known JNI bytes staged privately;
      exact four-root manifest 26,211 entries/612,576,408 B, aggregate
