...
- [ ] Odin fan: confirm by ear/feel that an adb `settings put system fan_mode 5` actually speeds the fan (Brad set 5 by hand on 09-26; the tools now keep it at 5 during runs and restore the pre-run value).
