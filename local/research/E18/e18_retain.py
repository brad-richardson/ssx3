#!/usr/bin/env python3
"""Archive closed E18 captures with hash verification; leave all SSD originals in place."""
import argparse
import gzip
import hashlib
import json
...
def main():
    ...
    canonical={}
    for old in sorted(EVIDENCE.glob('e18*-retained.json')):
    ...
    def keep(src,dest,compress=False):
        ...
        canonical[key]=dest
        # Source remains on SSD; no reclamation in E18.
    ...
    print('# E18 RETENTION TAIL COMPLETE; all retained originals verified against canonical content hashes; SSD originals preserved')
