...
def main():
    p=argparse.ArgumentParser();p.add_argument('phase',choices=['a','b','c','d']);a=p.parse_args();label='e18'+a.phase
    ...
    print(json.dumps(result,indent=2));print('# E18 FRAME TAIL COMPLETE')
