#!/usr/bin/env bash
# SS1 Part 3 Android build (F5 recipe): fork ss1-savestate (git archive) + paraLLEl ss1-clut (4 files over f2 19d93b2 copy)
...
ls /home/brad/ss1/codegen-ssx3 | wc -l
echo "== vu1gen input count =="
ls /home/brad/ss1/vu1gen | wc -l
echo "== gradlew argv =="
echo "$ext/gradlew assembleRelease -Pps2xBootElf=/storage/emulated/0/Android/data/com.ps2x.runner/files/SLUS_207.72 -Pps2xGameCodegenDir=/home/brad/ss1/codegen-ssx3 -Pps2xGsShadowParallel=ON -Pps2xParallelGsSourceDir=/home/brad/ss1/parallel-gs -Pps2xJniLibsDir=/home/brad/ss1/jniLibs -Pps2xVu1RecompDir=/home/brad/ss1/vu1gen --max-workers=2 --console=plain --warning-mode=none"
"$ext/gradlew" assembleRelease \
  -Pps2xBootElf=/storage/emulated/0/Android/data/com.ps2x.runner/files/SLUS_207.72 \
  -Pps2xGameCodegenDir=/home/brad/ss1/codegen-ssx3 \
  -Pps2xGsShadowParallel=ON \
  -Pps2xParallelGsSourceDir=/home/brad/ss1/parallel-gs \
  -Pps2xJniLibsDir=/home/brad/ss1/jniLibs \
  -Pps2xVu1RecompDir=/home/brad/ss1/vu1gen \
