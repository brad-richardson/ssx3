#!/usr/bin/env python3
"""F4 bounded boot: F3 driver + F4 codegen pins + --vu1-stats (B1 coverage gate).
...
WORK = Path('/Users/brad/dev/ssx3-work/F4')
ELF = Path('/Users/brad/dev/ssx3-work/E32-inputs/cd/SLUS_207.72')
ISO = Path('/Users/brad/dev/ssx3-work/E32-inputs/SSX 3 (USA).iso')
CODEGEN = Path('/Users/brad/dev/ssx3-work/F4/codegen/register_functions.cpp')
CODEGEN_VF0 = Path('/Users/brad/dev/ssx3-work/F4/codegen/sub_003FE828_0x3fe828.cpp')
...
def main():
    ...
    held = os.environ.get('F4_HELD_SLOT')
    if held:
        ...
        slot = claim('F4-' + args.label, exclusive=exclusive)
        while slot is None:
