#!/bin/sh
# G40: ONE Odin build of the G40-wall tree (final hunk, Mac-validated).
# Recipe = G31 (NON-sanitizer NDK r30 arm64, android-35), new SSD build dir.
set -e
export COPYFILE_DISABLE=1
CLONE="/Volumes/Extreme SSD/parallel-gs-g7"
BUILD="/Volumes/Extreme SSD/parallel-gs-g40-android-build"
