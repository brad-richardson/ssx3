#!/usr/bin/env bash
# F5 Android build: assembleRelease from f5-fold (unpushed; git archive
...
ls /home/brad/f5/codegen-ssx3 | wc -l
echo "== vu1gen input count =="
ls /home/brad/f5/vu1gen-f5 | wc -l
echo "== gradlew argv =="
echo "$ext/gradlew assembleRelease -Pps2xBootElf=/storage/emulated/0/Android/data/com.ps2x.runner/files/SLUS_207.72 -Pps2xGameCodegenDir=/home/brad/f5/codegen-ssx3 -Pps2xGsShadowParallel=ON -Pps2xParallelGsSourceDir=/home/brad/f5/parallel-gs -Pps2xJniLibsDir=/home/brad/f5/jniLibs -Pps2xVu1RecompDir=/home/brad/f5/vu1gen-f5 --max-workers=2 --console=plain --warning-mode=none"
"$ext/gradlew" assembleRelease \
  -Pps2xBootElf=/storage/emulated/0/Android/data/com.ps2x.runner/files/SLUS_207.72 \
  -Pps2xGameCodegenDir=/home/brad/f5/codegen-ssx3 \
  -Pps2xGsShadowParallel=ON \
  -Pps2xParallelGsSourceDir=/home/brad/f5/parallel-gs \
  -Pps2xJniLibsDir=/home/brad/f5/jniLibs \
  -Pps2xVu1RecompDir=/home/brad/f5/vu1gen-f5 \
