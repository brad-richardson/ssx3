...
from e20_validate import suite, validate, logged
...
for name,args in cases:
    cwd=P/'e20-fixtures/checkpoint-extra'/name;cwd.mkdir(parents=True,exist_ok=False)
...
print('# E20 CHECKPOINT REGRESSION TAIL COMPLETE')
