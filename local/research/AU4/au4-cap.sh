...
fail() { echo "AU4_FAIL:$1"; stamp; kill $(cat $T4/pcsx2-au4.pid) 2>/dev/null; sleep 5; exit 1; }
...
# Continue until at least 170 s of 36 kHz tag-1 PCM has been captured.
# This includes boot silence; the route itself adds substantial menu/race music.
