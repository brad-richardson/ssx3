#!/usr/bin/env python3
"""LX1 Mac parity boot: F2 driver at the LX1 work root (fork 0ed07c4, CPU GS,
sound off). I26-FAST to the race, det mode only in practice.
...
WORK = Path('/Users/brad/dev/ssx3-work/LX1')
...
def main():
    ...
    if held:
        ...
        slot = claim('LX1-' + args.label, exclusive=exclusive)
        while slot is None:
