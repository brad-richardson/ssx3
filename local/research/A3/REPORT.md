...
| docs/research/ps2recomp-spike-2026-09-12/README.md | # PS2Recomp feasibility spike (muse on bradflix, 2026-09-11/12) — recovered transcript | 2026-09-11 | 8473 | 2026-09-18 | handoff or snapshot | basename shared with other READMEs; referenced by commands-and-outputs |
...
| Device/foreign-machine paths | `docs/plan-120fps-2026-09-17.md`: `/data/local/tmp/mg/`, device serial; `docs/research/ps2recomp-spike-2026-09-12/*`: `/mmt/share/...`, `/home/brad/dev`, `/tmp/PS2Recomp`, `/tmp/ssx3vu`, `/tmp/SLUS_207.72`; `docs/research/120hz-f-spike.md`: `/tmp/ssx3-f120/...` | Transcript/plan content from other machines; recorded, not resolved. |
