#!/usr/bin/env python3
"""E41 boot wrapper: vsync-clock pad script + CD-read/plant trace.

Usage:
  python3 local/research/E41/e41_boot.py --label e41a --wall 300 --snap 30 \
      --script "..." --cd-from 0 --cd-to 1400
...
b.SPIKE = WORK
b.RUN = os.path.join(WORK, "E41-run")
