"""Full regression with the isolation-proven E22 observer. No title boot."""
from e22_common import *
from e22_validate import suite, validate
from e22_parser_receipt import receipt
assert os.environ.get('COPYFILE_DISABLE')=='1'
# E22 inherits E21's isolation proof by binary identity: the instrument is the
...
admission(sample())
os.environ['E22_OBSERVER_DYLIB']=str(E/'parser/e21-parser-observer.dylib')
...
rows=[]
for directory in [E/'.suite-observer/parser-observer',*sorted((P/'e22-fixtures/observer-bindings').glob('*/parser-observer')),
                  *sorted((P/'e22-fixtures/observer-closure').glob('*/parser-observer'))]:
...
print('# E22 OBSERVER REGRESSION TAIL COMPLETE')
