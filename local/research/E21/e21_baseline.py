...
from e21_validate import suite, validate, logged
...
for name,args in cases:
    cwd=P/'e21-fixtures/checkpoint-extra'/name;cwd.mkdir(parents=True,exist_ok=False)
...
print('# E21 CHECKPOINT REGRESSION TAIL COMPLETE')
