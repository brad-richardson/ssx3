...
from e21_io import read_capture
from e21_closed_events import tap,fields
from e21_parser_receipt import receipt
E=Path(__file__).resolve().parent
RUN=Path('/Volumes/Extreme SSD/ps2recomp-spike/P1/run');LABEL='e21a'
...
def main():
    ...
    save('e21a-observation-closure.json',dict(raw_sha256=hashlib.sha256(data).hexdigest(),raw_bytes=len(data),
    ...
    print('# E21 DEMAND-WATCH MINER TAIL COMPLETE')
