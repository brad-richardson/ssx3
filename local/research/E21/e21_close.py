...
assert json.loads((E/'e21a-result.json').read_text()).get('release_utc')
...
save('final-audit.json',dict(utc=utc(),fork=BASE_SHA,fork_commands=receipts,fork_source_changes=0,fork_commits=0,
    ...
    fixture=pin(P/'e18-fixtures/after/binding-test'),threshold_fixture=pin(P/'e21-fixtures/threshold/binding-test'),
...
print('# E21 FINAL AUDIT TAIL COMPLETE')
