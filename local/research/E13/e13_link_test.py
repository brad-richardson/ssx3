...
def main():
    ...
    label=sys.argv[1]; dest=Path('/Volumes/Extreme SSD/ps2recomp-spike/P1/e13-binding-tests')/label; dest.mkdir(exist_ok=True,parents=True)
    ...
    for n,a in enumerate(args):
        ...
        out.append(a)
    out+=['-c',str(HERE/'e13_binding_test.cpp'),'-o',str(dest/'test.o')]
    ...
    link += [str(dest/'test.o'),'-Wl,-e,_e13_binding_main','-Wl,-export_dynamic']
