#!/usr/bin/env python3
"""Pin E13 configs, active generated sources/bindings and executable identity."""
...
def main():
    ...
    for p in sources:
        if any(s in p.name for s in ['002C50E0','002C5140','002C52D8','002C5300','002C5338','002C5358','004261F0','00426230']):
