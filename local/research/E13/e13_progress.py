#!/usr/bin/env python3
"""Reproduce E13 progression and missing-query receipts from closed captures."""
import argparse
...
from e13_io import resolve, read_capture
...
def main():
    ...
    with (HERE/f'{label}-missing-query.txt').open('w') as f:
        ...
        f.write('# E13 MISSING QUERY TAIL COMPLETE\n')
    ...
    print('# E13 PROGRESSION MINER TAIL COMPLETE')
