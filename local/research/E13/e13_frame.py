...
import struct
import zlib
from e13_io import read_capture, resolve
...
def main():
    p=argparse.ArgumentParser();p.add_argument('phase',choices=['a','b','c','d']);a=p.parse_args();label='e13'+a.phase
    ...
    print(json.dumps(result,indent=2));print('# E13 FRAME TAIL COMPLETE')
