#!/usr/bin/env python3
"""Reproduce E16 progression and missing-query receipts from closed captures."""
import argparse
...
from e16_io import resolve, read_capture
...
def main():
    ...
    with (HERE/f'{label}-missing-query.txt').open('w') as f:
        ...
        f.write('# E16 MISSING QUERY TAIL COMPLETE\n')
    ...
    print('# E16 PROGRESSION MINER TAIL COMPLETE')
