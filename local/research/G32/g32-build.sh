#!/bin/sh
# G32: configure + build (sample_quad[0] unit-probe parallel-gs-replayer for Android arm64).
# NEW build dir (all older dirs untouched). Host builds -j2.
# Recipe = G22/G26/G28/G29/G30/G31 recipe (NON-sanitizer: no ANDROID_STL override, no
...
# + G32 pre-vsync() two-zone pattern-injection hunk in gs/gs_interface.cpp
# (GSInterface::vsync, pre-call, map_vram_write + G32: inject receipt).
# Receipts: configure exit 0, build exit 0 [458/458], binary size/sha/BuildID
# in REPORT.md, G32: strings x1/x1, G31: x1/x2, G30: x1/x1, G29: x1/x2, G28: x1, G26: x1.
set -e
export COPYFILE_DISABLE=1
CLONE="/Volumes/Extreme SSD/parallel-gs-g7"
BUILD="/Volumes/Extreme SSD/parallel-gs-g32-android-build"
