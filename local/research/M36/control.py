#!/usr/bin/env python3
"""M36 positive control: synthetic truth with KNOWN unnamed-cell values.

Usage: control.py M16_DIR

Imports interior_sites + tail core from m36.py (same dir);
...
from m36 import (interior_sites, jaccard, load_dump,  # noqa: E402
