"""E26 open: fork allocation baseline + initial admission against the contract.

E26 builds nothing and edits nothing in the fork. The allocation baseline is
...
save('admission-open.json', dict(utc=utc(), reservation_internal=IRES,
                                 ...
                                 note=('internal_allocated is dominated by the 1.77 GB E18 build tree E25 '
                                       'rebuilt bit-identically; E26 runs no build step, so the 3 GiB '
