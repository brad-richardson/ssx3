...
mode the errata names. E26 removes the possibility by construction:
...
save('tail-receipt.json', dict(utc=utc(), file=str(REPORT),
    ...
    verify_command=('python3 -c "import hashlib;L=open(\'local/research/E26/REPORT.md\')'
