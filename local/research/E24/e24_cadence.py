...
from e24_validate import validate, logged
from e24_parser_receipt import receipt
from e24_mine import fixture_cadence, parse_table
...
for bytes_fed in (60,120,180,240):
    dest=P/'e24-fixtures/cadence'/str(bytes_fed);dest.mkdir(parents=True,exist_ok=False)
...
print('# E24 CADENCE TAIL COMPLETE')
