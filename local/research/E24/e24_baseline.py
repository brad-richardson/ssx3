...
from e24_validate import suite, validate, logged
...
for name,args in cases:
    cwd=P/'e24-fixtures/checkpoint-extra'/name;cwd.mkdir(parents=True,exist_ok=False)
...
save('checkpoint-complete.json',dict(utc=utc(),suite=None,suite_status=suite_row.get('status','BLOCKED'),suite_receipt=suite_row,closure_cases=6,prior=[24,3,14,4,'DROP'],e15_rc=[0,0],extra_cases=8,boot=0,resources=sample()))
print('# E24 CHECKPOINT REGRESSION TAIL COMPLETE')
