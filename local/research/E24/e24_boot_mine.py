"""Mine the e24a boot: demand verdict, parser receipt, and the producer/source watch verdict."""
import re
from e24_common import *
from e24_closed_events import tap
from e24_parser_receipt import receipt
from e24_mine import fixture_cadence
RUN=P/'run'
cfg=json.loads((E/'e24a-config.json').read_text())
res=json.loads((E/'e24a-result.json').read_text())
...
print('# E24 BOOT MINE TAIL COMPLETE')
