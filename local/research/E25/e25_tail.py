...
mode the errata names. E25 removes the possibility by construction:
...
save('tail-receipt.json', dict(utc=utc(), file=str(REPORT),
    ...
    verify_command=('python3 -c "import hashlib;L=open(\'local/research/E25/REPORT.md\')'
