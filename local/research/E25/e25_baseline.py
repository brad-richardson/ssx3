...
from e25_validate import suite, validate, logged
...
for name,args in cases:
    cwd=P/'e25-fixtures/checkpoint-extra'/name;cwd.mkdir(parents=True,exist_ok=False)
...
save('checkpoint-complete.json',dict(utc=utc(),suite=458,suite_status='PASS',suite_receipt=suite_row,closure_cases=6,prior=[24,3,14,4,'DROP'],e15_rc=[0,0],extra_cases=8,boot=0,resources=sample()))
print('# E25 CHECKPOINT REGRESSION TAIL COMPLETE')
