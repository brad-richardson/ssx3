#!/usr/bin/env python3
"""E14-only oldest-first link-tree reclamation with a retained ownership gate."""
...
def main():
    ...
    assert checkpoint['matching_generated_names_hashes']==9452 and checkpoint['binding_present_rc']==1
    ...
    if args.mode=='probe':
        ...
        rec['retired_lane_receipt']=(E/'retired-lane-receipts.txt').read_text()
        assert '**T12 read' in rec['retired_lane_receipt'] and 'PASS' in rec['retired_lane_receipt'] and args.tree in rec['retired_lane_receipt']
    ...
    print('# E14 RECLAMATION TAIL COMPLETE '+args.mode+' '+args.tree)
