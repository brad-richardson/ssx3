#!/usr/bin/env python3
"""Recheck the five row receipts using only standalone E14 retained bytes."""
...
assert record['verified_count']==5 and record['excluded_count']==0
print('# E14 STANDALONE BYTE VERIFICATION TAIL COMPLETE')
