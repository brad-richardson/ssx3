...
extern "C" int e14_binding_main(int argc,char** argv) {
    try {
        ...
        if (argc==3) {
            ...
            require(pc==0x14f2a8 || pc==0x156750 || pc==0x243a80 || pc==0x395730 || pc==0x3a0158,"PC outside E14 scope");
            ...
            std::puts("E14 PRESENCE CHECK COMPLETE success=1 boot=0");return 0;
        }
        ...
        std::puts("E14 ACTUAL BINDING TEST COMPLETE success=1 boot=0"); return 0;
    } catch(const std::exception& e) {
        std::fprintf(stderr,"E14 ACTUAL BINDING TEST FAILURE: %s\n",e.what()); return 1;
    }
}
