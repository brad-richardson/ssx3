#!/usr/bin/env python3
"""Archive closed E17 captures with hash verification; leave all SSD originals in place."""
import argparse
import gzip
import hashlib
import json
...
def main():
    ...
    canonical={}
    for old in sorted(EVIDENCE.glob('e17*-retained.json')):
    ...
    def keep(src,dest,compress=False):
        ...
        canonical[key]=dest
        # Source remains on SSD; no reclamation in E17.
    ...
    print('# E17 RETENTION TAIL COMPLETE; all retained originals verified against canonical content hashes; SSD originals preserved')
