...
def main():
    p=argparse.ArgumentParser();p.add_argument('phase',choices=['a','b','c','d']);a=p.parse_args();label='e17'+a.phase
    ...
    print(json.dumps(result,indent=2));print('# E17 FRAME TAIL COMPLETE')
