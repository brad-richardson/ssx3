#!/usr/bin/env python3
"""Reproduce E17 progression and missing-query receipts from closed captures."""
import argparse
...
from e17_io import resolve, read_capture
...
def main():
    ...
    with (HERE/f'{label}-missing-query.txt').open('w') as f:
        ...
        f.write('# E17 MISSING QUERY TAIL COMPLETE\n')
    ...
    print('# E17 PROGRESSION MINER TAIL COMPLETE')
