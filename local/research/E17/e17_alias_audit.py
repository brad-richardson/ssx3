...
from e17_common import E, P, save
from e17_closed_events import tap
from e17_progress import stream
...
events,_=tap(P/'run/e17a-join/e7-events.txt')
...
with stream(P/'run/ps2_log-e17a-1.txt') as f:
...
print('# E17 OWNER ALIAS AUDIT TAIL COMPLETE')
