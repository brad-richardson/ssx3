#!/usr/bin/env python3
"""Join this E17 run's dynamic registration/request, guards, packets and images."""
import hashlib,json,re,struct
from collections import Counter
from pathlib import Path
from e17_io import read_capture,resolve
from e17_closed_events import tap,fields
from e17_packet import packet
from e17_frame import surface,census,field_surface,read_png,write_png,fnv32
...
def main():
    ...
    dump('e17a-graphics.json',graphics)
    ...
    dump('e17a-observation-closure.json',audit)
    ...
    print('# E17 JOIN MINER TAIL COMPLETE')
