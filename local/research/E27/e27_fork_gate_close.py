"""E27 gate 1, run BEFORE anything else touches a build: fork triple-agree.
...
save('fork-gate-close.json', out)
print(json.dumps({k: v for k, v in out.items() if k != 'commands'}, indent=2))
print('# E27 FORK GATE TAIL COMPLETE green=' + ('1' if green else '0'))
if not green:
