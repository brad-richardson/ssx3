...
| Tail receipt | Value |
|---|---|
| Complete prefix | Lines 1–193; 30837 B; SHA256 `bc1d5df14ad91ebfe943c7aa3196ded80609a95cc45302ad576ff6fb6f63a9aa` (the prefix is every line ABOVE the `\| Tail receipt \| Value \|` header, so this row lives after the boundary and cannot invalidate itself — errata E24-E2) |
