#!/usr/bin/env python3
"""Mine completed E11 captures only. Standard library; no guest execution."""
import argparse
...
def main():
    ...
    with (EVIDENCE/f'{label}-watch-series.txt').open('w') as f:
        ...
        f.write('# E11 WATCH SERIES TAIL COMPLETE\n')
    ...
    if True:
        ...
        with (EVIDENCE/f'{label}-burst-series.txt').open('w') as f:
            ...
            f.write('# E11 BURST SERIES TAIL COMPLETE\n')
    ...
    print('# E11 MINER TAIL COMPLETE',path)
