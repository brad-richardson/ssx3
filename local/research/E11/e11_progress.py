#!/usr/bin/env python3
"""Reproduce E11 progression and missing-query receipts from closed captures."""
import argparse
...
from e11_io import resolve, read_capture
...
def main():
    ...
    with (HERE/f'{label}-missing-query.txt').open('w') as f:
        ...
        f.write('# E11 MISSING QUERY TAIL COMPLETE\n')
    ...
    print('# E11 PROGRESSION MINER TAIL COMPLETE')
