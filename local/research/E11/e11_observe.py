#!/usr/bin/env python3
"""Install E11's bounded read-only extension of the existing E7 sink."""
import os
...
def main():
    ...
    s=s.replace(anchor,(E/'e11_card_observe.inc').read_text()+'\n'+anchor)
    ...
    s=s.replace(anchor,'''    // E11: retain inputs to the already-reached sibling residual; no dispatch or result change.
...
'''+anchor)
    ...
    print('# E11 observation extension installed; no generated source mutation')
