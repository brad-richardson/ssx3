#!/usr/bin/env bash
# N8D7M12P6M6R build (orchestrator-steered): P3 build.sh with root
# n8d7m12p6m6 and in-root codegen, invoking the EXTERNAL pinned wrapper
# /home/brad/n8d7m12p3/PS2Recomp/android/gradlew as a build tool from the
# new root/android cwd. No file is copied into the four staged source roots.
