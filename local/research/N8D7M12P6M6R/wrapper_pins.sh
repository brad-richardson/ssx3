#!/usr/bin/env bash
# N8D7M12P6M6R wrapper pin verify (read-only): double-read the external
# pinned wrapper files and confirm they equal the orchestrator pins.
# Expected:
...
new=/home/brad/n8d7m12p6m6/PS2Recomp/android
echo "== double reads =="
