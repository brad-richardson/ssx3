#!/usr/bin/env python3
"""E37 boot wrapper: vsync-clock pad script + gfx stats + VU1 entry trace.

Usage:
  python3 local/research/E37/e37_boot.py --label e37a --wall 300 \
...
b.SPIKE = WORK
b.RUN = os.path.join(WORK, "E37-run")
