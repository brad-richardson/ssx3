#!/usr/bin/env python3
"""Compare the N8D7M1 snapshot with N8D7H, excluding generated caches.

Expected: exactly one fork backend differs (the N8D7L oracle overlay);
the three G43 diagnostic files and jniLibs stay byte-identical. Double-read
every overlay/header/codegen/Turnip/HAL pin in both WSL roots.
"""
...
root = Path('/home/brad/n8d7m1')
base = Path('/home/brad/n8d7h')
backend = 'ps2xRuntime/src/lib/gs/ps2_gs_parallel_backend.cpp'
header = 'ps2xRuntime/include/runtime/gs/ps2_gs_psmct32.h'
...
assert out['diff'] == {'fork': [backend], 'parallel': [], 'jniLibs': []}, out['diff']

pins = {
    'backend': (root/'PS2Recomp'/backend, '84a13a80686be8d4ed17750a9399d298ea6b998b98f48d3720b6b5bc839a4645'),
    'header': (root/'PS2Recomp'/header, '9635a40e11bae56189b64d1d9660fb68d0375444d355db43246973adb95e71f7'),
    'header_base': (base/'PS2Recomp'/header, '9635a40e11bae56189b64d1d9660fb68d0375444d355db43246973adb95e71f7'),
