#!/usr/bin/env python3
"""N8D7M1 WSL package gate: double-read archive and members.

Requires exactly the arm64 runner/Turnip/HAL members, unchanged Turnip/HAL
pins, a NEW runner Build ID, every N8D7L/N8D7F/oracle/prior-stage string, and
the sole arm64 CMake cache pointing at the N8D7M1 G43/external codegen with the
five diagnostics/UI flags OFF.
"""
import hashlib
import json
...
n8d7h_runner_build_id = '1c1bce61bfe6bc21cd2ac86d473da323f480eb7b'
...
assert out['runner_build_id'] != n8d7h_runner_build_id, 'runner Build ID unchanged from N8D7H'
