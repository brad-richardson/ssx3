...
def main():
    ...
    label=sys.argv[1]; dest=Path('/tmp')/('e9-binding-'+label); dest.mkdir(exist_ok=True)
    ...
    for n,a in enumerate(args):
        ...
        out.append(a)
    out+=['-c',str(HERE/'e9_binding_test.cpp'),'-o',str(dest/'test.o')]
    ...
    link += [str(dest/'test.o'),'-Wl,-e,_e9_binding_main','-Wl,-export_dynamic']
