...
extern "C" int e9_binding_main(int argc,char** argv) {
    try {
        ...
        std::puts("E9 ACTUAL BINDING TEST COMPLETE success=1 boot=0"); return 0;
    } catch(const std::exception& e) {
        std::fprintf(stderr,"E9 ACTUAL BINDING TEST FAILURE: %s\n",e.what()); return 1;
    }
}
