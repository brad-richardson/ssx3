#!/usr/bin/env python3
"""Reproduce E8 progression and missing-query receipts from closed captures."""
import argparse
...
from e8_io import resolve, read_capture
...
def main():
    ...
    with (HERE/f'{label}-missing-query.txt').open('w') as f:
        ...
        f.write('# E8 MISSING QUERY TAIL COMPLETE\n')
    ...
    print('# E8 PROGRESSION MINER TAIL COMPLETE')
