#!/usr/bin/env python3
"""T44 gradient-gated rider tracker: T42's retuned tracker with a GRADIENT lock.

T44 Task 1 (T40-G1 third arm, static test on T42 R3's 12 committed dense
...
in-band-biased snaps. See T44 REPORT for the full calibration table.
Deterministic: identical bytes in -> identical out.

Usage: t44-track.py snap1.jpg [snap2.jpg ...]
