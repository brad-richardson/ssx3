#!/bin/bash
# I29: pinned, optimized iOS builds (sim + device) at fork fb11e18; stage,
...
PIN=fb11e182310555c65201635f8d6c7fe8e170de74
...
for step in "$@"; do echo "[i29 $(date +%H:%M:%S)] stage $step"; "$step"; done
