...
VR1_HELD_SLOTS set), then releases every slot. Two ~90 s boots per hold keep
...
It never measures while this lane's own build runs (VR1/BUILDING exists).
...
WORK = '/Users/brad/dev/ssx3-work/VR1'
        ...
        for c in cands:
            ...
            with open('%s/boot-%s.txt' % (WORK, label), 'w') as out:
                child = subprocess.Popen(
                    ['python3', '/Users/brad/dev/ssx3/local/research/VR1/vr1_boot.py',
