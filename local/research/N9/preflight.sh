#!/usr/bin/env bash
# N9 Part 2 preflight: fresh root absent, toolchain/governor, disk, heavy jobs.
# Read-only except stdout. Adapted from N8D7M12P6M6R/preflight.sh (root n9).
set -euo pipefail
test ! -e /home/brad/n9 && echo "n9 absent OK"
