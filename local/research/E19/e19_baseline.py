...
from e19_validate import suite, validate, logged
...
for name,args in cases:
    cwd=P/'e19-fixtures/checkpoint-extra'/name;cwd.mkdir(parents=True,exist_ok=False)
...
print('# E19 CHECKPOINT REGRESSION TAIL COMPLETE')
