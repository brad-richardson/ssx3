#!/usr/bin/env python3
"""Reproduce E15 progression and missing-query receipts from closed captures."""
import argparse
...
from e15_io import resolve, read_capture
...
def main():
    ...
    with (HERE/f'{label}-missing-query.txt').open('w') as f:
        ...
        f.write('# E15 MISSING QUERY TAIL COMPLETE\n')
    ...
    print('# E15 PROGRESSION MINER TAIL COMPLETE')
