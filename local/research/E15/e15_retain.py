#!/usr/bin/env python3
"""Compress/move only closed E15-owned captures, verify hashes, retain one copy."""
import argparse
import gzip
import hashlib
import json
...
def main():
    ...
    canonical={}
    for old in sorted(EVIDENCE.glob('e15*-retained.json')):
    ...
    print('# E15 RETENTION TAIL COMPLETE; every removed raw verified against its canonical content hash')
