#!/usr/bin/env bash
# VK2 Android build: F6 recipe, source = fork branch vk2 (git archive
...
set -euo pipefail
root=/home/brad/vk2fix   # VK2 source root; every other input read-only from /home/brad/f6
...
ls /home/brad/f6/codegen-ssx3 | wc -l
echo "== vu1gen input count =="
ls /home/brad/f6/vu1gen-f6 | wc -l
echo "== parallel-gs knob =="
grep -m1 'PGS_HIER_BINNING' /home/brad/f6/parallel-gs/gs/gs_renderer.cpp | cut -c1-80
echo "== gradlew argv =="
echo "$ext/gradlew assembleRelease -Pps2xBootElf=/storage/emulated/0/Android/data/com.ps2x.runner/files/SLUS_207.72 -Pps2xGameCodegenDir=/home/brad/f6/codegen-ssx3 -Pps2xGsShadowParallel=ON -Pps2xParallelGsSourceDir=/home/brad/f6/parallel-gs -Pps2xJniLibsDir=/home/brad/f6/jniLibs -Pps2xVu1RecompDir=/home/brad/f6/vu1gen-f6 --max-workers=2 --console=plain --warning-mode=none"
"$ext/gradlew" assembleRelease \
  -Pps2xBootElf=/storage/emulated/0/Android/data/com.ps2x.runner/files/SLUS_207.72 \
  -Pps2xGameCodegenDir=/home/brad/f6/codegen-ssx3 \
  -Pps2xGsShadowParallel=ON \
  -Pps2xParallelGsSourceDir=/home/brad/f6/parallel-gs \
  -Pps2xJniLibsDir=/home/brad/f6/jniLibs \
  -Pps2xVu1RecompDir=/home/brad/f6/vu1gen-f6 \
