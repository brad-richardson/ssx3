...
# paraLLEl-GS 19d93b2 + TL1 jniLibs. Adapted from F1/build.sh (root f2).
...
ls /home/brad/f2/codegen-ssx3 | wc -l
echo "== gradlew argv =="
echo "$ext/gradlew assembleRelease -Pps2xBootElf=/storage/emulated/0/Android/data/com.ps2x.runner/files/SLUS_207.72 -Pps2xGameCodegenDir=/home/brad/f2/codegen-ssx3 -Pps2xGsShadowParallel=ON -Pps2xParallelGsSourceDir=/home/brad/f2/parallel-gs -Pps2xJniLibsDir=/home/brad/f2/jniLibs --max-workers=2 --console=plain --warning-mode=none"
"$ext/gradlew" assembleRelease \
  -Pps2xBootElf=/storage/emulated/0/Android/data/com.ps2x.runner/files/SLUS_207.72 \
  -Pps2xGameCodegenDir=/home/brad/f2/codegen-ssx3 \
  -Pps2xGsShadowParallel=ON \
  -Pps2xParallelGsSourceDir=/home/brad/f2/parallel-gs \
  -Pps2xJniLibsDir=/home/brad/f2/jniLibs \
