...
than once, at different points in the lane, and `e29_restore_gate.py` compares
...
Usage: e29_restore.py <pass-number>
"""
...
save(f'restore-pass-{n}.json', dict(utc=utc(), passno=n, ssd_link=link, rows=rows,
     ...
     note=('Two back-to-back reads per file inside this pass; the lane runs this tool more '
           'than once and e29_restore_gate.py compares ACROSS passes, which is the '
...
print(f'# E29 RESTORE PASS {n} TAIL COMPLETE')
