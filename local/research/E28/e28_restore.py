...
than once, at different points in the lane, and `e28_restore_gate.py` compares
...
Usage: e28_restore.py <pass-number>
"""
...
save(f'restore-pass-{n}.json', dict(utc=utc(), passno=n, ssd_link=link, rows=rows,
     ...
     note=('Two back-to-back reads per file inside this pass; the lane runs this tool more '
           'than once and e28_restore_gate.py compares ACROSS passes, which is the '
...
print(f'# E28 RESTORE PASS {n} TAIL COMPLETE')
