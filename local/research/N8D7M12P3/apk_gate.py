#!/usr/bin/env python3
"""N8D7M12P3 WSL package gate: double-read archive and members.

Requires exactly the arm64 runner/Turnip/HAL members, unchanged Turnip/HAL
pins (equal to the N8D7M1 pins), a runner Build ID NEW vs N8D7M1, every
replay + selected/oracle string, and the sole arm64 CMake cache pointing at
the N8D7M12P3 G43/external codegen with PS2X_BUILD_TEST and the five
diagnostics/UI flags OFF and shadow-parallel ON.
"""
import hashlib
import json
