...
git -C "$G" diff -- pcsx2/Interpreter.cpp pcsx2/R5900OpcodeImpl.cpp pcsx2/Vif_Transfer.cpp > /home/brad/pcsx2-t4/t64-patch.diff
sha256sum /home/brad/pcsx2-t4/t64-patch.diff
wc -c /home/brad/pcsx2-t4/t64-patch.diff
echo T61_PATCH_DONE
