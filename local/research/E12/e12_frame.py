...
import struct
import zlib
from e12_io import read_capture, resolve
...
def main():
    p=argparse.ArgumentParser();p.add_argument('phase',choices=['a','b','c','d']);a=p.parse_args();label='e12'+a.phase
    ...
    print(json.dumps(result,indent=2));print('# E12 FRAME TAIL COMPLETE')
