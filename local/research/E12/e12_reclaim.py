#!/usr/bin/env python3
"""E12-only oldest-first link-tree reclamation with a retained ownership gate."""
...
def main():
    ...
    assert checkpoint['matching_generated_names_hashes']==9450 and checkpoint['binding_present_rc']==1
    ...
    print('# E12 RECLAMATION TAIL COMPLETE '+args.mode+' '+args.tree)
