...
from e23_validate import suite, validate, logged
...
for name,args in cases:
    cwd=P/'e23-fixtures/checkpoint-extra'/name;cwd.mkdir(parents=True,exist_ok=False)
...
print('# E23 CHECKPOINT REGRESSION TAIL COMPLETE')
