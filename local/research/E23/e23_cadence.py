...
from e23_validate import validate, logged
from e23_parser_receipt import receipt
from e23_mine import fixture_cadence, parse_table
...
for bytes_fed in (60,120,180,240):
    dest=P/'e23-fixtures/cadence'/str(bytes_fed);dest.mkdir(parents=True,exist_ok=False)
...
print('# E23 CADENCE TAIL COMPLETE')
