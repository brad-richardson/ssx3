#!/usr/bin/env bash
# VR4 fold Android compile (VR3 recipe): source = git archive of vr4-fold b97b241 (f0d2d3c + D1 + default ON), paraLLEl = canonical 3d72467 tar (no -Pps2xVu1FmacSimd: the default applies); codegen / VU1 set d28e3fc6 / jniLibs / VU0 image = VR3 inputs
...
grep -m1 'PGS_HIER_BINNING' /home/brad/vr4fold/parallel-gs-ssx3/gs/gs_renderer.cpp | cut -c1-80
echo "== gradlew argv =="
echo "$ext/gradlew assembleRelease -Pps2xBootElf=/storage/emulated/0/Android/data/com.ps2x.runner/files/SLUS_207.72 -Pps2xGameCodegenDir=/home/brad/vr2d/codegen-ssx3 -Pps2xGsShadowParallel=ON -Pps2xParallelGsSourceDir=/home/brad/vr4fold/parallel-gs-ssx3 -Pps2xJniLibsDir=/home/brad/vr2d/jniLibs -Pps2xVu1RecompDir=/home/brad/vr2d/vu1gen -Pps2xVu0RecompDir=/home/brad/vr3/vu0gen --max-workers=2 --console=plain --warning-mode=none"
"$ext/gradlew" assembleRelease \
  ...
  -Pps2xParallelGsSourceDir=/home/brad/vr4fold/parallel-gs-ssx3 \
