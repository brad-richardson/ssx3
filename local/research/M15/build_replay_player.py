...
header compiled into the player is local/research/M5/m5_replay_context.h
(the M5 header derived from S2's), never native/diagnostics/native_frame_replay.h.
...
S2_HEADER = ROOT / "local/research/M15/m15_replay_context.h"
