#!/usr/bin/env python3
"""Mine completed E10 captures only. Standard library; no guest execution."""
import argparse
...
import re
import struct
from e10_io import read_capture
...
def main():
    ...
    with (EVIDENCE/f'{label}-watch-series.txt').open('w') as f:
        ...
        f.write('# E10 WATCH SERIES TAIL COMPLETE\n')
    ...
    if True:
        ...
        with (EVIDENCE/f'{label}-burst-series.txt').open('w') as f:
            ...
            f.write('# E10 BURST SERIES TAIL COMPLETE\n')
    ...
    print('# E10 MINER TAIL COMPLETE',path)
