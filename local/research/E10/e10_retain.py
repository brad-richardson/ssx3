#!/usr/bin/env python3
"""Compress/move only closed E10-owned captures, verify hashes, retain one copy."""
import argparse
import gzip
import hashlib
import json
...
def main():
    ...
    rows=[]
    canonical={}
    for old in sorted(EVIDENCE.glob('e10*-retained.json')):
    ...
    print('# E10 RETENTION TAIL COMPLETE; every removed raw verified against its canonical content hash')
