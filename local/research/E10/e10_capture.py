#!/usr/bin/env python3
"""E10 progression capture driver. Explicit preflight, caps, owned lease cleanup."""
import argparse
import datetime
import hashlib
import json
...
from e10_frame import read_png, fnv32
EVIDENCE = REPO / 'local/research/E10'
...
def preflight(label):
    ...
    assert manifest_path.exists(), 'fresh E10 build manifest required'
...
def main():
    ...
    assert not (EVIDENCE/f'e10{args.phase}-result.json').exists(), 'phase already used'
    label='e10'+args.phase
