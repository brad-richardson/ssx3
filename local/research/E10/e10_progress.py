#!/usr/bin/env python3
"""Reproduce E10 progression and missing-query receipts from closed captures."""
import argparse
...
from e10_io import resolve, read_capture
...
def main():
    ...
    with (HERE/f'{label}-missing-query.txt').open('w') as f:
        ...
        f.write('# E10 MISSING QUERY TAIL COMPLETE\n')
    ...
    print('# E10 PROGRESSION MINER TAIL COMPLETE')
