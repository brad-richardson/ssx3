...
cmake -S /Users/brad/dev/ssx3-work/I27B/PS2Recomp -B $W/build -G Ninja -DCMAKE_BUILD_TYPE=Release \
  -DCMAKE_C_COMPILER=/opt/homebrew/opt/llvm/bin/clang \
  -DCMAKE_CXX_COMPILER=/opt/homebrew/opt/llvm/bin/clang++ \
  -DPS2X_ENABLE_AGRESSIVE_LOGS=OFF -DPS2X_ENABLE_RUNTIME_LOGS=OFF \
  -DPS2X_ENABLE_DIAG_TAPS=OFF -DPS2X_BUILD_TEST=ON -DPS2X_BUILD_STUDIO=OFF \
...
cd $W/build
ninja -j8 ps2x_tests ps2EntryRunner > $W/build.log 2>&1
