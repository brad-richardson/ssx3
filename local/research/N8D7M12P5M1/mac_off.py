#!/usr/bin/env python3
"""N8D7M12 Part 5M1: one Mac OFF replay driver (PREPARED, unexecuted).
...
SCRATCH = Path.home() / "dev/ssx3-work" / "N8D7M12P5M1"
...
LEASE_LABEL = "n8d7m12p5m1-mac-off"
...
result = {"brief": "N8D7M12P5M1", "replay_count": 0, "hashes": {},
...
def run():
    ...
    if (SCRATCH / "result.json").exists() or (SCRATCH / "driver.log").exists():
        raise SystemExit("one-run guard: N8D7M12P5M1 receipt already exists")
