...
| Corrected direct replay vs live | Pending escalated replacement boot. The earlier sandboxed boot was void. | `~/dev/ssx3-work/GB4/run/boot-part2-wrapper.jsonl`, `run/boot-gb4cap2-1.log` document the void attempt. |
